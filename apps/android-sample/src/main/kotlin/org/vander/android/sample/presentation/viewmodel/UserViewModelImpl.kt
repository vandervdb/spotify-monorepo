...
@HiltViewModel
open class UserViewModelImpl @Inject constructor(private val userRepository: UserRepository) : ViewModel(),
    UserViewModel {

    override val currentUser = userRepository.observeCurrentUser()
