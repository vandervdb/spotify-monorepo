...
import {SpotifyLogo, useAuthStore, usePlayingStore} from '@spotify/client';
...
export const DefaultApp = () => {
    ...
    useEffect(() => {
        authStore.loadToken();
        playingStore.loadNowPlaying();
    }, [authStore, playingStore]);
                    ...
                    <View style={styles.section}>
                        <View style={styles.hero}>
                            ...
                            <TouchableOpacity
                                ...
                                <Text style={[styles.textMd, styles.textCenter]}>Spotify Player</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </ScrollView>
