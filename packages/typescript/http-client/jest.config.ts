...
const config: Config = {
    ...
    moduleNameMapper: {
        ...
        '^@react-native-spotify/core-constants$':
            '<rootDir>/../core-constants/src',
        ...
        '^@react-native-spotify/keychain-service$':
            '<rootDir>/../keychain-service/src',
        '^@react-native-spotify/spotify-client$':
            '<rootDir>/../spotify-client/src',
