...
interface SpotifyBridgeApi {
    ...
    suspend fun startUpWithModuleActivityResult(activity: Activity, config: AuthConfigK? = null)
    suspend fun startUpWithHostActivityResult(activity: Activity, config: AuthConfigK? = null)
