import { AuthClient, AuthStore, SecureStorage, TokenData } from '@core/domain';
...
export class DefaultAuthStore implements AuthStore {
    ...
    get isTokenValid(): boolean {
        return (
            this.authParams.token !== '' &&
            this.authParams.expiresAt > Date.now()
        );
    }
